        ...
        <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
          ...
          <nav class="mt-5  space-y-0.5 ">
            ...
            <nav class="mt-2  space-y-0.5 ">
              ...
              <a href="{{ route('back-office.archives') }}"
                class="{{ request()->routeIs('back-office.archives') ? 'bg-gray-100 before:h-full before:w-1 relative before:bg-gray-500 before:rounded-r before:absolute before:left-0 ' : '' }} text-gray-600 group flex items-center px-4 py-2 text-sm hover:bg-gray-100 ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                  class="mr-3 h-6 w-6 flex-shrink-0 text-gray-600">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" />
                </svg>
                Archives
              </a>
              <a href="{{ route('back-office.stock-movements') }}"
                class="{{ request()->routeIs('back-office.stock-movements') ? 'bg-gray-100 before:h-full before:w-1 relative before:bg-gray-500 before:rounded-r before:absolute before:left-0 ' : '' }} text-gray-600 group flex items-center px-4 py-2 text-sm hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                  class="mr-3 h-6 w-6 flex-shrink-0 text-gray-600">
              ...
              <a href="{{ route('back-office.price-changes') }}"
                class="{{ request()->routeIs('back-office.price-changes') ? 'bg-gray-100 before:h-full before:w-1 relative before:bg-gray-500 before:rounded-r before:absolute before:left-0 ' : '' }} text-gray-600 group flex items-center px-4 py-2 text-sm hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                  class="mr-3 h-6 w-6 flex-shrink-0 text-gray-600">
